...
In the test folder, use the run_all script after making it executable to create a iso and mount it within a vm.
Make sure that qemu, grub2-mkrescue and xorriso are installed.
